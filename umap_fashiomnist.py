...
train_features = np.load('one_layered_wdn/train_features_Fashion_MNIST_old_rbm_cnn_levels_1_21.npy')
train_labels = np.load('one_layered_wdn/train_labels_Fashion_MNIST_old_rbm_cnn_levels_1_21.npy')
